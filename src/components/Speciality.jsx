...
function Speciality() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10 xl:pl-24 lg:pl-8 justify-evenly items-center pb-10 select-none md:pl-16 md:gap-6">
      {data.map((item, index) => (
        <div
          key={item.id}
          className="relative xl:h-[300px] xl:w-[300px] lg:h-[280px] lg:w-[280px] md:h-[280px] md:w-[280px] rounded-2xl overflow-hidden cursor-pointer"
