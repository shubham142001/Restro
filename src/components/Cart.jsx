  ...
  return (
    <>
      <div className='select-none xl:h-[450px] lg:h-[850px] w-[95%] md:h-[650px] m-auto rounded-2xl my-10 shadow-2xl flex justify-between items-center flex-col'>
        <div className=' w-[95%] xl:h-[360px] lg:h-[700px]  md:h-[550px] overflow-hidden p-3 flex'>
          <div className=' h-16 w-[100%] flex justify-between lg:px-16 md:px-8 items-center border-b-2 border-gray-500 md:gap-36 lg:gap-0'>
            ...
            <div className='flex justify-between items-center lg:gap-24 md:gap-12'>
        ...
        <div className=' h-[80px] w-[95%] border-t-2 border-red-500 flex gap-4 justify-end text-3xl items-center pt-4 font-semibold lg:pr-44 md:pr-24' >
