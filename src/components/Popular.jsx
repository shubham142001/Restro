  ...
  return (
    <>
      <div className='sm:grid lg:grid-cols-3 sm:grid-cols-2 px-0 select-none sm:pl-4 flex flex-shrink-0 overflow-scroll gap-10 scrollbar-none'>
        {data.map((data) => (
          <div key={data.id} className="xl:h-[400px] xl:w-[350px] md:h-[370px] md:w-[300px] bg-gray-100 border-8 rounded-2xl shadow-lg m-auto mb-20 sm:h-[320px] sm:w-[250px] h-[400px] w-[360px] flex-shrink-0 ml-6  sm:ml-0 ">
            <div className="xl:h-[150px] xl:w-[300px] lg:h-[130px] lg:w-[250px] md:h-[150px] md:w-[300px] sm:h-[150px] sm:w-[300px] pt-4 flex m-auto sm:pl-2 pl-3 ">
              <img
                className="xl:h-[200px] xl:w-[300px] lg:h-[180px] lg:w-[250px] md:h-[180px] md:w-[270px] sm:h-[150px] sm:w-[200px] h-[200px] w-[320px]  object-cover rounded-lg overflow-hidden "
                src={data.image}
                alt={data.name}
              />
            </div>
